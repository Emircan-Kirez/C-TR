...
• Projeyle alakalı herhangi bir soru ve öneri için "emircan200123@hotmail.com" mail adresi üzerinden, konu başlığına "Github | C-TR / DFS ile labirent cozumu"
...
/* Kullanýlan Matris TEK Boþlukludur
+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
|     |     |                             |
+ +-+ + +-+-+ +-+-+-+-+-+-+-+-+-+ +-+-+-+ +
|   |   |     |   |   |         |   |     |
...
//Dosyadan okuduðum satýrlarý sakladýðým linkli liste
typedef struct lineNode{
	char line[100];
	struct lineNode *next;
}LINES; 

//x ve y indislerini birlikte tutmak için oluþturduðum struct
